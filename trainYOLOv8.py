...
yamlPath = "D:/Work/WatchTower/Yolo-v8/train0/fire-seg.yaml"
...
# model = YOLO('fire-seg.pt')  # Load a custom model for segmentation
...
results_gpu_1 = model.train(data=yamlPath, epochs=100, imgsz=640, device=0, workers=0)
